...
function Footer() {
    return ( 
        ...
        <div className="container border-top mt-5 " >
            ...
            <div className="footer-p mt-5 text-muted" style={{lineHeight:"1.2rem"}}>
            <p>
